...
function setup() {
  ...
  box12 = new YellowBox(600,360,20,30);
  box13 = new BlueBox(600,360,20,30);
  box14 = new RedBox(600,360,20,30);
  box15 = new GreenBox(600,360,20,30);
...
function mouseDragged(){
  Matter.Body.setPosition(ball.body,{x:mouseX,ymouseY});
}
